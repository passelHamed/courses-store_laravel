        ...
        <div class="card-body">
            ...
            @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input name="isbn" type="number" id="isbn" class="form-control @error('isbn') is-invalid @enderror" value="{{ old('isbn') }}" autocomplete="isbn">
                        @error('isbn')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input name="number_of_pages" type="number" id="number_of_pages" class="form-control @error('number_of_pages') is-invalid @enderror" value="{{ old('number_of_pages') }}" autocomplete="number_of_pages">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input name="number_of_copies" type="number" id="number_of_copies" class="form-control @error('number_of_copies') is-invalid @enderror" value="{{ old('number_of_copies') }}" autocomplete="number_of_copies">
